...
using namespace std;
/**
 * main() file to test BinaryHeapMPQ. Basically, in this file there are 5 test cases.
 * 1. Sorted order
 * 2. Reverse sorted order
 * 3. Random order
 * 4. Removing from empty BinaryHeapMPQ
 * 5. Complex case: performing all the above operations together
 * Use this file to test BinaryHeapMPQ.
 */

int main() {
    {
        BinaryHeapMPQ<int> mpq;
